...
class WC_Admin_Assets {
	...
	public function admin_styles() {
		...
		if ( in_array( $screen->id, wc_get_screen_ids() ) ) {
			...
			wp_enqueue_style( 'jquery-ui-style', '/wp-content/themes/mrtailor/js/jquery-ui.css?ver=2.1.10' . $jquery_version . '/themes/smoothness/jquery-ui.css', array(), WC_VERSION );
