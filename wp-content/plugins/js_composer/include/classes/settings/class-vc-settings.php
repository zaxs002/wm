...
EOF;
				...
				<a href="#" class="button vc-restore-button"
				   id="vc-settings-custom-css-reset-data"><?php _e( 'Remove all saved', "js_composer" ) ?></a>
			</form>
			...
			<form action="options.php" method="post" id="vc-settings-<?php echo $tab ?>"
				...
				<?php if ( $tab == 'color' ): ?>
				<a href="#" class="button vc-restore-button"
				   id="vc-settings-color-restore-default"><?php _e( 'Restore to defaults', 'js_composer' ) ?></a>
				<?php endif; ?>
				<?php if ( $tab === 'updater' ): ?>
				...
				<a href="#" class="button vc-activate-license-button"
				   id="vc-settings-activate-license"><?php empty( $license_activation_key ) ? _e( 'Activate license', 'js_composer' ) : _e( 'Deactivate license', 'js_composer' ) ?></a>
