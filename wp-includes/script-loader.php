...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'prototype', '/wp-content/themes/mrtailor/js/prototype.js', array(), '1.7.1');
	$scripts->add( 'scriptaculous-root', '/wp-content/themes/mrtailor/js/scriptaculous.js', array('prototype'), '1.9.0');
	$scripts->add( 'scriptaculous-builder', '/wp-content/themes/mrtailor/js/builder.js', array('scriptaculous-root'), '1.9.0');
	$scripts->add( 'scriptaculous-dragdrop', '/wp-content/themes/mrtailor/js/dragdrop.js', array('scriptaculous-builder', 'scriptaculous-effects'), '1.9.0');
	$scripts->add( 'scriptaculous-effects', '/wp-content/themes/mrtailor/js/effects.js', array('scriptaculous-root'), '1.9.0');
	$scripts->add( 'scriptaculous-slider', '/wp-content/themes/mrtailor/js/slider.js', array('scriptaculous-effects'), '1.9.0');
	$scripts->add( 'scriptaculous-sound', '/wp-content/themes/mrtailor/js/sound.js', array( 'scriptaculous-root' ), '1.9.0' );
	$scripts->add( 'scriptaculous-controls', '/wp-content/themes/mrtailor/js/controls.js', array('scriptaculous-root'), '1.9.0');
	...
	// jQuery
	$scripts->add( 'jquery', false, array( 'jquery-core', 'jquery-migrate' ), '2.1.1' );
	$scripts->add( 'jquery-core', '/wp-includes/js/jquery/jquery.js', array(), '2.1.1' );
